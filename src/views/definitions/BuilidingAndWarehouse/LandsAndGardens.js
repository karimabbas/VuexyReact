...
import { Box, Map, Search, Mail, MessageSquare, CheckSquare, Calendar, Edit2, FileText, Circle, ShoppingCart, User, Phone, Smartphone, Printer, Smile, Send, Key, Globe, Home, PenTool, Edit, Edit3, Hash, DollarSign, Terminal, Clock, Archive } from 'react-feather'
import AutoCompleteInput from '../../our-componnets/AutoCompleteInput'
import { Area } from 'recharts'
import { FaBoxOpen, FaHandPeace, FaPeace, FaSignature } from 'react-icons/fa'
import { SingleValue } from 'react-select/animated/dist/react-select.cjs.dev'
                        ...
                        <FormGroup>
                            ...
                            <InputGroup className='input-group-merge mb-2'>
                                ...
                                <Input
                                    ...
                                    name='area'
                                    innerRef={props.register({ required: true })}
                                    invalid={props.errors.area && true}
                                    placeholder='اسم المنطقة'
                                />
                            </InputGroup>

                            {props.errors && props.errors.area && <FormFeedback>ادخل نص صحيح</FormFeedback>}
                        </FormGroup>
                    </Col>
                </Row>
                <Row>
                    <Col sm='4' md='4'>
                        <FormGroup>
                            <Label for='hoodNo'>رقم الحوض</Label>
                            <InputGroup className='input-group-merge' tag={FormGroup}>
                                <InputGroupAddon addonType='prepend'>
                                    <InputGroupText>
                                        <FaBoxOpen className='headings' size={15} />
                                    </InputGroupText>
                                </InputGroupAddon>
                                <Input
                                    id='hoodNo'
                                    ...
                                    innerRef={props.register({ required: true })}
                                    invalid={props.errors.hoodNo && true}
                                />
                            </InputGroup>


                            {props.errors && props.errors.hoodNo && <FormFeedback>ادخل نص صحيح</FormFeedback>}
                        </FormGroup>
                    </Col>

                    <Col sm='4' md='4'>
                        <FormGroup>
                            <Label for='picNo'>رقم القطعة</Label>

                            <InputGroup className='input-group-merge' tag={FormGroup}>
                                <InputGroupAddon addonType='prepend'>
                                    <InputGroupText>
                                        <FaPeace className='headings' size={15} />
                                    </InputGroupText>
                                </InputGroupAddon>
                                <Input
                                    id='picNo'
                                    ...
                                    innerRef={props.register({ required: true })}
                                    invalid={props.errors.picNo && true}
                                />
                            </InputGroup>

                            {props.errors && props.errors.picNo && <FormFeedback>ادخل نص صحيح</FormFeedback>}
                        </FormGroup>
                    </Col>
                        ...
                        <FormGroup>
                            ...
                            <InputGroup className='input-group-merge' tag={FormGroup}>
                                ...
                                <Input
                                    ...
                                    placeholder='ملاحظات'
                                    innerRef={props.register({ required: true })}
                                    invalid={props.errors.notes && true}
                                />
                            </InputGroup>
                        </FormGroup>
                    </Col>
...
export default LandsAndGardens