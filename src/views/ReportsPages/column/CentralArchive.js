...
export const CentralArchive = (type) => [
    {
        name: '#',
    ...
    },
    {
        ...
        cell: row => {
            ...
            else if (row.type === 'citArchive') return 'أرشيف المواطنين'
            else if (row.type === 'financeArchive') return 'أرشيف المالية'
            else if (row.type === 'lawArchieve') return 'أرشيف القوانين والأجراءات'
