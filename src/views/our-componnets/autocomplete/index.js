...
const OurAutocomplete = props => {
  ...
  const onSuggestionItemClick = (url, e) => {
    ...
    // const obj = {
    //   [props.filterKey]: filteredData[activeSuggestion][props.filterKey],
    //   id: filteredData[activeSuggestion].id,
    //   model: filteredData[activeSuggestion].model
    // }
    props.onSelect(filteredData[activeSuggestion])
  ...
  return (
    <div className='input-group-merge autocomplete-container input-group' ref={container}>
      ...
      <Input
        ...
        name={props.name}
        id={props.id}
        className={`autocomplete-search radiusForce ${props.className ? props.className : ''}`}
        placeholder={props.placeholder}
        onClick={onInputClick}
        ref={inputElRef}
        innerRef={props.register ? props.register({ required: true }) : null}
